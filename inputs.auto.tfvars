...
approved_security_users = [
  "user:bini@biniayalew.joonix.net", "user:billing-manager@isolator-base-project.iam.gserviceaccount.com", # Users need to be in the format user:jdoe@example.com
]
